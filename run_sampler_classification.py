...
def read_data_all(data_path, phase):
    ...
    events["anli"], targets["anli"] = read_data(data_path + '/aNLI/mtl_common_anli_'+ phase + '_ti.txt')
    events["hella"], targets["hella"] = read_data(data_path + '/HellaSwag/mtl_common_hellaswag_'+ phase + '_ti.txt')
    events["copa"], targets["copa"] = read_data(data_path + '/COPA/mtl_common_copa_'+ phase + '_ti.txt')
    events["joci"], targets["joci"] = read_data(data_path + '/JOCI/mtl_common_joci_'+ phase + '_ti.txt')
    events["atomic"], targets["atomic"] = read_data(data_path + '/defeasible/defeasible-atomic/mtl_common_atomic_'+ phase + '_ti.txt')
    events["social"], targets["social"] = read_data(data_path + '/defeasible/defeasible-social/mtl_common_social_'+ phase + '_ti.txt')
    events["snli"], targets["snli"] = read_data(data_path + '/defeasible/defeasible-snli/mtl_common_snli_'+ phase + '_ti.txt')
